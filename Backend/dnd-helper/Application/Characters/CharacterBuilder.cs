...
public static class CharacterBuilder
{
        ...
        BackgroundOptionDto? background)
    {
        ...
        {
            errors["baseAbilities"] = ["Каждая базовая характеристика должна быть задана вручную в пределах от 3 до 18."];
        }
        ...
        IReadOnlyList<string> inventory)
    {
        ...
        return new CharacterComputationResult(
            ...
            skills,
            [],
            characterClass.SavingThrowProficiencies.ToList(),
    ...
    private static bool HasValidAbilityScores(IReadOnlyList<BaseAbilityScoreDto> abilities)
    {
        ...
        return keys.SequenceEqual(expectedKeys)
            && abilities.All(item => item.Score >= 3 && item.Score <= 18);
    }
